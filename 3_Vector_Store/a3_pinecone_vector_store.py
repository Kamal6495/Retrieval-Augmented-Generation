...
results = vector_store_pinecone.similarity_search("Who among is Physicists", k=3)
for r in results:
...
print("\n🔍 Pinecone Similarity Search with Score")
results_score = vector_store_pinecone.similarity_search_with_score("Who among is Physicists", k=3)
...
vector_store_pinecone.add_documents([updated_doc], ids=["doc1"])

# ❌ Delete a document
vector_store_pinecone.delete(ids=["doc2"])
